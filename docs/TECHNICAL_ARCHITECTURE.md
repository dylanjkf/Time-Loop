...
4. **Actor-vs-actor collision:** if two or more actors intend the same destination tile, all of them are cancelled (nobody moves into a contested tile) — this avoids order-dependent "winner" ambiguity.
